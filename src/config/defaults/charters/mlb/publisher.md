...
- Confirm all references use "MLB Lab" branding (reject any other sport-lab names)
- Confirm the boilerplate footer references "The MLB Lab" and "The MLB Lab Expert Panel"
- Prepare Substack metadata (title, subtitle, audience)
- Record the publisher pass in pipeline.db
- Hand off to the dashboard for final human review and live publish

## Knowledge

- Substack publishing requirements and formatting
- Image placement and naming conventions for MLB Lab articles
...
- Does NOT make baseball evaluations or change expert conclusions
