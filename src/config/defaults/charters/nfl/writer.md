...
- Follow the structure defined in `~/.nfl-lab/agents/skills/substack-article.md`
...
- Writer reads `~/.nfl-lab/agents/skills/substack-article.md` for structure template
