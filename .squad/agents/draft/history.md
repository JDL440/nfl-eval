# Draft — Draft Expert History

## Core Context
- **Project:** NFL Roster Evaluation — 2026 Offseason
- **User:** Joe Robinson
- **Data Sources:** overthecap.com, spotrac.com, ESPN/NFL.com, PFF, The Athletic, mock draft sites, NFL Mock Draft Database, CBS Sports, Sporting News, FantasyPros, StatRankings
...
### 2026 Draft Overview
_Last updated: 2025-07-17 via ESPN, NFL.com, Sporting News, Wikipedia_

- ✅ **Dates:** April 23–25, 2026 (Thu R1 8pm ET, Fri R2-3 7pm ET, Sat R4-7 noon ET)
- ✅ **Location:** Pittsburgh, PA — Acrisure Stadium (main stage) + Point State Park (fan experience)
- ✅ **Broadcast:** ESPN, ABC, NFL Network, ESPN+
- ✅ **Free admission** via NFL OnePass app registration

**Key Storylines:**
- ✅ Fernando Mendoza (QB, Indiana) is consensus #1 overall — Heisman winner, National Championship winner, compared to Joe Burrow's 2019 rise
- 📊 QB class is shallow behind Mendoza — Arch Manning, Nico Iamaleava, LaNorris Sellers all returned to school
- 📊 Defense-heavy class — elite EDGE, LB, S talent pushing into top 10
- 📊 Running back Jeremiyah Love challenging the "RBs fall" trend
- 📊 Ohio State and Miami (FL) dominate early-round projections

---

### Top 30 Consensus Big Board
_Last updated: 2025-07-17 via NFL Mock Draft Database, PFF, CBS, Sporting News, FantasyPros, StatRankings_

| Rank | Player | Pos | School | Projected Rd | Confidence |
|------|--------|-----|--------|-------------|------------|
| 1 | Fernando Mendoza | QB | Indiana | 1 (Top 1) | ✅ |
| 2 | Arvell Reese | LB/EDGE | Ohio State | 1 (Top 3) | 📊 |
| 3 | Rueben Bain Jr. | EDGE | Miami (FL) | 1 (Top 5) | 📊 |
| 4 | Jeremiyah Love | RB | Notre Dame | 1 (Top 5) | 📊 |
| 5 | Caleb Downs | S | Ohio State | 1 (Top 5) | 📊 |
| 6 | Francis Mauigoa | OT | Miami (FL) | 1 (Top 10) | 📊 |
| 7 | Carnell Tate | WR | Ohio State | 1 (Top 10) | 📊 |
| 8 | David Bailey | EDGE | Texas Tech | 1 (Top 10) | 📊 |
| 9 | Spencer Fano | OT | Utah | 1 (Top 10) | 📊 |
| 10 | Mansoor Delane | CB | LSU | 1 (Top 12) | 📊 |
| 11 | Sonny Styles | LB | Ohio State | 1 (Top 15) | 📊 |
| 12 | Makai Lemon | WR | USC | 1 (Top 15) | 📊 |
| 13 | Jordyn Tyson | WR | Arizona State | 1 (Top 15) | 📊 |
| 14 | Monroe Freeling | OT | Georgia | 1 (Top 15) | 📊 |
| 15 | Jermod McCoy | CB | Tennessee | 1 (Top 18) | 📊 |
| 16 | Olaivavega Ioane | IOL | Penn State | 1 (Top 18) | 📊 |
| 17 | Kenyon Sadiq | TE | Oregon | 1 (Top 20) | 📊 |
| 18 | Keldric Faulk | EDGE | Auburn | 1 (Top 20) | 📊 |
| 19 | Peter Woods | DL | Clemson | 1 (Top 20) | 📊 |
| 20 | Avieon Terrell | CB | Clemson | 1 (Top 22) | 📊 |
| 21 | Dillon Thieneman | S | Oregon | 1–2 | 📊 |
| 22 | Akheem Mesidor | EDGE | Miami (FL) | 1–2 | 📊 |
| 23 | Caleb Banks | DL | Florida | 1–2 | 📊 |
| 24 | Kadyn Proctor | OT | Alabama | 1–2 | 📊 |
| 25 | Denzel Boston | WR | Washington | 1–2 | 📊 |
| 26 | Caleb Lomu | OT | Utah | 1–2 | 📊 |
| 27 | C.J. Allen | LB | Georgia | 1–2 | 📊 |
| 28 | Cashius Howell | EDGE | Texas A&M | 1–2 | 📊 |
| 29 | KC Concepcion | WR | Texas A&M | 1–2 | 📊 |
| 30 | Emmanuel McNeil-Warren | S | Toledo | 1–2 | 📊 |

---

### Positional Rankings
_Last updated: 2025-07-17 via PFF, ESPN, CBS, Sporting News, Ready For The Draft, Tankathon_

**QB:**
1. ✅ Fernando Mendoza — Indiana (consensus QB1, Heisman/Natty winner, 6'5", elite arm)
2. 📊 Ty Simpson — Alabama (strong arm, athletic)
3. 📊 Garrett Nussmeier — LSU (productive SEC passer)
4. ❓ LaNorris Sellers — South Carolina (dual-threat, returned to school — 2027 eligible?)
5. ❓ Carson Beck — Miami / Dante Moore — Oregon (questions about NFL readiness)

**EDGE:**
1. 📊 Rueben Bain Jr. — Miami (FL) (dense, strong, technically refined)
2. 📊 David Bailey — Texas Tech (explosive pass rusher, coverage ability)
3. 📊 Keldric Faulk — Auburn (athletic, high upside)
4. 📊 Akheem Mesidor — Miami (FL) (consistent disruptor)
5. 📊 Cashius Howell — Texas A&M
6. ❓ T.J. Parker — Clemson (rising, great closing burst)

**WR:**
1. 📊 Carnell Tate — Ohio State (elite size, route-running, hands)
2. 📊 Makai Lemon — USC (dynamic playmaker, YAC ability)
3. 📊 Jordyn Tyson — Arizona State (polished routes, NFL speed)
4. 📊 Denzel Boston — Washington (size and production)
5. 📊 KC Concepcion — Texas A&M (reliable hands, separation)

**OT:**
1. 📊 Francis Mauigoa — Miami (FL) (massive, athletic, dominant)
2. 📊 Spencer Fano — Utah (nimble, zone-blocking fit, RAS 9.76)
3. 📊 Monroe Freeling — Georgia
4. 📊 Caleb Lomu — Utah
5. 📊 Kadyn Proctor — Alabama
6. ❓ Blake Miller — Clemson
7. ❓ Max Iheanachor — Arizona State (4.95 40 at 6'6" 321 lbs, trending Rd 1)

**CB:**
1. 📊 Mansoor Delane — LSU (zero TDs allowed in 2025, elite coverage)
2. 📊 Jermod McCoy — Tennessee (physical, ball skills)
3. 📊 Avieon Terrell — Clemson (NFL bloodlines, natural cover corner)
4. ❓ Colton Hood — Tennessee
5. ❓ Brandon Cisse — South Carolina

**S:**
1. 📊 Caleb Downs — Ohio State (consensus top-5 talent, day-one starter)
...
**LB:**
1. 📊 Arvell Reese — Ohio State (versatile, pass-rush upside, top-3 talent)
2. 📊 Sonny Styles — Ohio State (historic combine, sub-4.5 at 230+)
3. 📊 C.J. Allen — Georgia
4. ❓ Anthony Hill Jr. — Texas
5. ❓ Jacob Rodriguez — Texas Tech

**DL (Interior):**
1. 📊 Caleb Banks — Florida (disruptive, athletic)
2. 📊 Peter Woods — Clemson (size + athleticism)
3. ❓ Kayden McDonald — Ohio State
4. ❓ Lee Hunter — Texas Tech
5. ❓ Christen Miller — Georgia

**RB:**
1. 📊 Jeremiyah Love — Notre Dame (back-to-back 1,000-yard seasons, receiving ability, top-15 talent)
...
**TE:**
1. 📊 Kenyon Sadiq — Oregon (4.39 40, 43.5" vert, 26 bench reps — historic combine)
2. ❓ Jack Endries — Texas
3. ❓ Eli Stowers — Vanderbilt (45.5" vert, 11'3" broad)
4. ❓ Oscar Delp — Georgia
5. ❓ Joe Royer — Cincinnati

**IOL:**
1. 📊 Olaivavega Ioane — Penn State (first-round talent)
2. ❓ Others TBD — thinner positional group for early rounds

---

### First-Round Draft Order
_Last updated: 2025-07-17 via ESPN, NFL.com, CBS, Sporting News_
...
| 11 | ✅ Miami Dolphins | |
| 12 | ✅ Dallas Cowboys | |
| 13 | ✅ Los Angeles Rams | **NFC WEST** (from ATL) |
| 14 | ✅ Baltimore Ravens | |
...
| 32 | ✅ Seattle Seahawks | **NFC WEST** |

**Teams without R1 picks:** ATL, GB, IND, JAX

---

### NFC West Draft Capital
_Last updated: 2025-07-17 via NFL.com, Sportsnaut, RealGM, Sharp Football_

#### Arizona Cardinals (Pick 3 overall)
| Round | Pick # | Notes |
|-------|--------|-------|
| ✅ 1 | 3 | Own pick |
| ✅ 2 | 34 | Own pick |
...
| ✅ 6 | 183 | Own pick |
| ✅ 7 | 217 | Own pick |
**Total: 7 picks, all 7 rounds. Full draft capital intact.**

#### Los Angeles Rams (Pick 13 overall)
| Round | Pick # | Notes |
|-------|--------|-------|
| ✅ 1 | 13 | From Atlanta Falcons via trade |
| ✅ 2 | 61 | Own pick |
| ✅ 3 | 93 | Own pick |
| ❓ 4-7 | TBD | Own R1 pick (#29) traded to KC; later rounds unclear |
**Note: Rams traded their own R1 pick to KC. The ATL pick gives them a higher first-rounder than they'd have had.**

#### San Francisco 49ers (Pick 27 overall)
| Round | Pick # | Notes |
|-------|--------|-------|
| ✅ 1 | 27 | Own pick |
| ✅ 2 | 58 | Own pick |
| ❓ 3 | — | Traded to Dallas Cowboys |
| ❓ 4-7 | TBD | Partially intact, details TBD |
**Note: Missing R3 pick (sent to DAL). Limited mid-round capital.**

#### Seattle Seahawks (Pick 32 overall)
| Round | Pick # | Notes |
|-------|--------|-------|
| ✅ 1 | 32 | Own pick |
| ✅ 2 | 64 | Own pick |
| ✅ 3 | 96 | Own pick |
| ❓ 4-6 | TBD | Believed intact |
| ❓ 7 | — | Traded to Cleveland Browns |
**Note: Missing R7 pick (sent to CLE). Otherwise intact through R1-R3.**

---

### NFL Combine Highlights
_Last updated: 2025-07-17 via CBS, Sharp Football, Dynasty Nerds, ESPN, DAZN_

**Fastest 40-Yard Dash Times:**
| Player | Pos | School | Time |
|--------|-----|--------|------|
| ✅ Brenen Thompson | WR | Mississippi State | 4.26s |
| ✅ Lorenzo Styles Jr. | S | Ohio State | 4.27s |
| ✅ Zavion Thomas | WR | LSU | 4.28s |
| ✅ Deion Burks | WR | Oklahoma | 4.30s |
| ✅ Jeff Caldwell | WR | Cincinnati | 4.31s |

**Combine Risers (stock UP):**
- 📊 **Sonny Styles** (LB, Ohio State) — Historic combine: sub-4.5 40, 40"+ vert, 11'+ broad at 230+ lbs → firmly top 15
- 📊 **Kenyon Sadiq** (TE, Oregon) — 4.39 40 (fastest TE in 20+ years), 43.5" vert, 11'1" broad, 26 bench → locked first round
- 📊 **Jeremiyah Love** (RB, Notre Dame) — Great all-around testing, cemented RB1 status
- 📊 **Spencer Fano** (OT, Utah) — 4.91 40, RAS 9.76, but 32" arms raised concerns
- 📊 **Deion Burks** (WR, Oklahoma) — 4.30 40, 42.5" vert, 26 bench
- 📊 **Arvell Reese** (EDGE/LB, Ohio State) — 4.46 40, 1.58 10-yd split at 241 lbs → moving into top-3 conversation
- 📊 **Max Iheanachor** (OT, Arizona State) — 4.95 40 at 6'6" 321 lbs → trending toward Rd 1

**Combine Concerns (did not test or underwhelmed):**
- ❓ Rueben Bain Jr. — Did not test at combine
- ❓ Peter Woods — Did not test
- ❓ Akheem Mesidor — Did not test
- ❓ C.J. Allen — Did not test
- ❓ Francis Mauigoa — Skipped workouts
- ❓ Monroe Freeling — Skipped workouts
- ❓ Spencer Fano arm length (32") — concern for some teams

**Other Notable Results:**
- ✅ Top vertical: Eli Stowers (TE, Vanderbilt) — 45.5"
- ✅ Best 3-cone: Germie Bernard (WR, Alabama) — 6.71s
- ✅ Best shuttle: Vinny Anthony II (WR, Wisconsin) — 4.07s
- ✅ Top bench: Kenyon Sadiq (TE) & Jordyn Tyson (WR) — 26 reps each

---

### Mock Draft Trends & Consensus
_Last updated: 2025-07-17 via NFL Mock Draft Database, ESPN, FantasyPros, ClutchPoints, Stadium Rant, DraftCountdown_

**Consensus First-Round Mock Projections:**

| Pick | Team | Most Commonly Mocked | Confidence |
|------|------|---------------------|------------|
| 1 | LV Raiders | Fernando Mendoza (QB, Indiana) | ✅ Near-universal |
| 2 | NY Jets | Arvell Reese (LB/EDGE, Ohio State) | 📊 |
| 3 | **ARI Cardinals** | Rueben Bain Jr. (EDGE, Miami) or David Bailey (EDGE, TTU) | 📊 |
| 4 | TEN Titans | Carnell Tate (WR, Ohio State) or Jeremiyah Love (RB, ND) | ❓ |
| 5 | NY Giants | Caleb Downs (S, Ohio State) | 📊 |
| 6 | CLE Browns | Francis Mauigoa (OT, Miami) | 📊 |
| 13 | **LA Rams** | WR/OT/CB depending on mock | ❓ |
| 27 | **SF 49ers** | BPA — varies widely | ❓ |
| 32 | **SEA Seahawks** | BPA — varies widely | ❓ |

**Major Themes:**
1. 📊 **Defense dominates the top 10** — EDGE, LB, S taking premium slots; unusual for safeties/LBs this high
2. 📊 **Shallow QB class** — Only Mendoza is consensus R1; Ty Simpson is fringe R1. Teams may trade up for Mendoza or wait for 2027 (Arch Manning)
3. 📊 **O-line demand** — Mauigoa, Fano, Ioane all projected top 16; league-wide tackle need
4. 📊 **RB value rising** — Love is challenging the "don't draft RBs early" trend
5. 📊 **Ohio State pipeline** — Reese, Downs, Tate, Styles all top-15 prospects from one school
6. 📊 **Miami (FL) pipeline** — Bain, Mauigoa, Mesidor all first-round caliber
7. ❓ **Trade-up scenarios** — QB-needy teams may target Mendoza; trade-down teams (TEN, NYG) could capitalize
8. 📊 **Non-premium positions rising** — TE Sadiq, S Downs, LB Reese all projected top 15-20 despite traditional positional devaluation

---

### NFC West Draft Context
_Last updated: 2025-07-17_

**Arizona Cardinals (Pick 3):**
- 📊 Most mocks have ARI taking an EDGE rusher (Bain Jr. or Bailey) at #3
- 📊 Premium pick position — could trade down for massive haul if they prefer
- 📊 Full 7-round draft capital gives maximum flexibility

**Los Angeles Rams (Pick 13 via ATL):**
- 📊 Mid-first pick positions them for top WR, OT, or CB talent
- 📊 Traded their own R1 to KC — the ATL trade was critical to maintaining first-round presence
- ❓ Later-round capital may be thin

**San Francisco 49ers (Pick 27):**
- 📊 Late first-round pick — likely BPA approach
- 📊 Missing R3 pick limits mid-draft options
- ❓ May need to trade up if a specific target falls

**Seattle Seahawks (Pick 32):**
- 📊 Last pick of R1 — typically BPA territory
- 📊 Mostly intact capital (R1-R3) minus R7
- ❓ Could trade back into early R2 for more picks
...
|------|-------|--------|------------|--------|
| — | No active draft-specific rumors tracked yet | — | — | — |

_Rumor tracking will activate as draft day approaches and beat reporters begin sourcing team interest._

---

### Learnings

- ✅ NFL Mock Draft Database consensus big board is the best aggregator for cross-source prospect rankings
- ✅ PFF, CBS, ESPN, and Sporting News are the most reliable individual big board sources
- ✅ Combine data is available via CBS, Sharp Football Analysis, Dynasty Nerds, Big Board Lab
