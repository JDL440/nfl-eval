# Decision: Publish-Flow Architecture — Draft-First Model

**Date:** 2026-03-24  
**Submitted by:** Publisher Agent  
...
Editorial expectation should be:
- close enough for final read-through and layout QA
- explicit that Substack remains the final source of truth for exact rendering
...
# Decision: Publish Flow UX — Two-Step Model with Explicit Workflow

**Date:** 2026-03-24  
**Submitted by:** UX Agent  
**Status:** FINDINGS — Ready for team implementation  
