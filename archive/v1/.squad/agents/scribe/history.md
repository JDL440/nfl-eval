...
- Silent-success merge repairs should update the canonical decision in place, append only minimal non-duplicative history notes, log the merge, and then delete preserved inbox files while leaving `.gitkeep` intact.
